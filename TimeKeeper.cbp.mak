...
RESINC = 
LIBDIR = 
LIB = -lPocoFoundation glade-2.0
LDFLAGS = `pkg-config gtk+-2.0 --libs` -export-dynamic

INC_DEBUG = $(INC) -I/nix/store/krs1vd4s6wq8kzjx3ck8kxl6j57s656x-libglade-2.6.4-dev/include/libglade-2.0
CFLAGS_DEBUG = $(CFLAGS) -march=athlon-fx -g
RESINC_DEBUG = $(RESINC)
RCFLAGS_DEBUG = $(RCFLAGS)
LIBDIR_DEBUG = $(LIBDIR) -L../CommonLib/bin/Debug
LIB_DEBUG = $(LIB)libCommonLib.a
...
LIB_RELEASE = $(LIB)libCommonLib.a
